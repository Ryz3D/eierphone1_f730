...
int main(void)
{
  ...
  coreTaskHandle = osThreadNew(core, NULL, &coreTask_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, KB_COL_1_Pin|KB_COL_2_Pin|KB_COL_3_Pin|KB_COL_4_Pin
  ...
  /*Configure GPIO pins : KB_COL_1_Pin KB_COL_2_Pin KB_COL_3_Pin KB_COL_4_Pin
                           KB_COL_5_Pin KB_COL_6_Pin */
  GPIO_InitStruct.Pin = KB_COL_1_Pin|KB_COL_2_Pin|KB_COL_3_Pin|KB_COL_4_Pin
                          |KB_COL_5_Pin|KB_COL_6_Pin;
  ...
  /*Configure GPIO pins : KB_ROW_B_Pin KB_ROW_A_Pin KB_ROW_C_Pin KB_ROW_D_Pin
                           KB_ROW_E_Pin KB_ROW_F_Pin KB_ROW_G_Pin KB_ROW_H_Pin
                           KB_ROW_I_Pin */
  GPIO_InitStruct.Pin = KB_ROW_B_Pin|KB_ROW_A_Pin|KB_ROW_C_Pin|KB_ROW_D_Pin
                          |KB_ROW_E_Pin|KB_ROW_F_Pin|KB_ROW_G_Pin|KB_ROW_H_Pin
                          |KB_ROW_I_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
